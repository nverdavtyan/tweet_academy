  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="">
        <div class="text-center">
         <span  class="modal-title font-weight-bold text-center" id="exampleModalLongTitle">
          <span style="font-size: 20px;">Welcome to the Tweet Academy <span style="color:#207ce5"><?php echo $user->name; ?></span>  </span>  
         </span>
        </div>
      ...
      <div class="modal-body">
        ...
        <p>This is Tweeet academy is developed by <span style="font-weight: 700;color:black !important;">Nver , Johan, Chrishtophe , Mohamed and Dorian</span>  for learning purpose.</p>
      </div>
    ...
    <div class="wrapper-left">
      ...
      <div class="grid-posts">
              ...
              <div class="input-group-login" id="whathappen">
                ...
                <div class="container">
                  <div class="part-1">
                    ...
                    <div class="text">
                      <form  action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                        <div class="inner">
            
                            <img src="assets/images/users/<?php echo $user->avatar ?>" alt="profile photo">
                        
                          <label>
            
                            <textarea class="text-whathappen" name="content" rows="8" cols="80" placeholder="What's happening?"></textarea>
        ...
        <div class="wrapper-right">
          ...
          <a style="" href="<?php echo $user->username;  ?>">
                      <img
                        src="assets/images/users/<?php echo $user->avatar; ?>"
                        alt=""
                        class="img-share"
