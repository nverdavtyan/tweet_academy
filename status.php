...
<head>
  ...
  <title>Content | Tweet Academy</title>
      ...
      <div class="sidebar-left">
        ...
        <div class="grid-sidebar bg-active" style="margin-top: 12px">
          ...
          <div class="wrapper-left-elements">
            <a href="home.php" style="margin-top: 4px;">
              Home</a>
          </div>
        </div>
        ...
        <div class="box-user">
          <div class="grid-user">
            <div>
              <img src="assets/images/users/<?php echo $user->avatar ?>" alt="user" class="img-user" />
            </div>
            <div>
      ...
      <div class="border-right">
        ...
        if (Tweet::isTweet($tweet->id)) {
          ...
          if ($retweet->message == null) {
            ...
            $timeAgo = Tweet::getTimeAgo($tweet_real->tweet_date);
            ...
            if ($retweeted_tweet->tweet_id != null) {
              ...
              // if($retweeted_tweet->) 
              $tweet_user = User::getData($retweeted_tweet->user_id);
              $timeAgo = Tweet::getTimeAgo($retweeted_tweet->tweet_date);
              $likes_count = Tweet::countLikes($retweeted_tweet->tweet_id);
              $user_like_it = Tweet::userLikeIt($user_id, $retweeted_tweet->tweet_id);
              $retweets_count = Tweet::countRetweets($retweeted_tweet->tweet_id);
              $user_retweeted_it = Tweet::userRetweeetedIt($user_id, $retweeted_tweet->tweet_id);
            ...
            if ($retweet->message != null) {
              ...
              if ($inner_qoute == null) {
                ...
                $tweet_innerr = Tweet::getRetweet($tweet_inner->tweet_id);
                $inner_qoute = $tweet_innerr->message;
        ...
        <div class="box-tweet feed" style="position: relative;">
          ...
          <div class="grid-tweet">
            <a style="position: relative; z-index:1000" href="<?php echo $tweet_user->username;  ?>">
              <img src="assets/images/users/<?php echo $tweet_user->avatar; ?>" alt="" class="img-user-tweet" />
            </a>
            ...
            <div>
              ...
              <p>
                ...
                else echo  Tweet::getTweetLinks($tweet_real->content); ?>
              </p>
              <?php if ($retweet_comment == false && $qoq == false) { ?>
                <?php if ($tweet_real->media != null) { ?>
                  <p class="mt-post-tweet">
                    <img src="assets/images/tweets/<?php echo $tweet_real->media; ?>" alt="" class="img-post-tweet" />
                  </p>
                <?php }
              } else { ?>
                ...
                <div class="mt-post-tweet comment-post" style="position: relative;">
                  ...
                  <a href="content/<?php echo $tweet_inner->id; ?>">
                  ...
                  <div class="grid-tweet py-3 ">
                    ...
                    <a style="position: relative; z-index:1000" href="<?php echo $user_inner_tweet->username;  ?>">
                      <img src="assets/images/users/<?php echo $user_inner_tweet->avatar; ?>" alt="" class="img-user-tweet" />
                    </a>
                    ...
                    <div>
                      ...
                      if ($qoq == false) {
                        if ($tweet_inner->img != null) { ?>
                          <p class="mt-post-tweet">
                            <img src="assets/images/tweets/<?php echo $tweet_inner->media; ?>" alt="" class="img-post-retweet" />
                          </p>
                      <?php }
                      } ?>
              ...
              <div class="row home-follow pt-3">
                ...
                <?php if ($likes_count > 0) { ?>
                  <div class="col-md-2 users-count">
                    <div class="likes-u" data-tweet="<?php
                                                      if ($retweet_sign)
                                                        echo $retweeted_tweet->id;
                                                      else  echo $tweet->id; ?>">
              ...
              <div class="grid-reactions">
                ...
                <div class="grid-box-reaction">
                  ...
                  <div class="hover-reaction hover-reaction-retweet
                    ...
                    " data-retweeted="<?php echo $user_retweeted_it; ?>" data-sign="<?php echo $retweet_sign; ?>" data-tmp="<?php echo $retweet_comment; ?>" data-qoq="<?php echo $qoq; ?>" data-content="<?php echo true; ?>">
        ...
        <div class="comments">
          ...
          <?php foreach ($comments as $comment) {
            ...
            $timeAgo = Tweet::getTimeAgo($comment->date_comment);
                ...
                <div>
                  ...
                  <div class="grid-reactions">
                    <div class="grid-box-reaction-rep">
                      <div class="hover-reaction-rep hover-reaction-comment reply" data-user="<?php echo $user_id; ?>" data-tweet="<?php
                                                                                                                                    echo $comment->id; ?>">
            ...
            <div class="grid-share">
              ...
              <div>
                <button class="follow-btn follow-btn-m 
                      <?= $user_follow ? 'following' : 'follow' ?>" data-follow="<?php echo $user->id; ?>" data-user="<?php echo $user_id; ?>" data-profile="<?php echo $user_id; ?>" style="font-weight: 700;">
                  <?php if ($user_follow) { ?>
                    Following
                  <?php } else {  ?>
                    Follow
