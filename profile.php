          ...
          <div class="box-home feed">
               <div class="container">
                 ...
                 <div class="row mt-5">
                    ...
                    <div class="col-md-12">
                      <img class="w-100 home-img-cover" src="assets/images/users/<?php echo $profileData->cover; ?>" alt="">
                    </div>

                 </div>

                 <div class="row justify-content-between">
                      <img class="home-img-user" src="assets/images/users/<?php echo $profileData->avatar; ?>" alt="">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="image-upload">
                                ...
                                <i style="top: 80px;
                                 ...
                                 font-size:18px " class="fas fa-times position-absolute"></a> 
                                  ...
                                  <img id="preview-cover" class="w-100 home-img-cover" src="assets/images/users/<?php echo $profileData->cover; ?>" alt="">
                            </div>
                            </div>
                            ...
                            <img id="preview-user" class="home-img-user" src="assets/images/users/<?php echo $profileData->avatar; ?>" alt="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <input type="text" name="country" class="form-control" id="exampleInputEmail1" value="<?php if ($user->country!== null) 
                            echo $user->country ;?>" aria-describedby="emailHelp" placeholder="Bio">
                            </div>
                        <div class="form-group">
                  ...
                  <?php } ?>
                    <p class="bio"><?php echo $profileData->country; ?> </p>
                  </div>
                  ...
                  <div class="row home-loc-link ml-2">
                    ...
                    <i class="fas fa-link"></i><?php echo parse_url($profileData->website, PHP_URL_HOST);; ?>
                  </a> </li>
                    </div>
                    <?php } ?>
                    ...
                    <div class="col-md-4">
                    <li> 
                    <i class="fas fa-calendar">Joined</i><?php echo $profileData->register_date; ?>
                  </a> </li>
                    </div>
                  </div>
