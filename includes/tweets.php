...
if ($retweet->message == null) {
    ...
    $retweeted_tweet = Tweet::getRetweet($retweet->retweet_id);
       ...
       // if($retweeted_tweet->) 
        ...
        $likes_count = Tweet::countLikes($retweeted_tweet->id) ;
        $user_like_it = Tweet::userLikeIt($user_id ,$retweeted_tweet->id);
        $retweets_count = Tweet::countRetweets($retweeted_tweet->id) ;
        $user_retweeted_it = Tweet::userRetweeetedIt($user_id ,$retweeted_tweet->id);
...
?>
        ...
        <img
        src="assets/images/users/<?php echo $tweet_user->avatar; ?>"
        alt=""
        ...
        <img
        src="assets/images/tweets/<?php echo $tweet_real->media; ?>"
        alt=""
 ...
 <?php if($comment_count > 0) echo $comment_count; ?>  </p> 
        </div>
        </div>
        </div>
        <div class="grid-box-reaction">
